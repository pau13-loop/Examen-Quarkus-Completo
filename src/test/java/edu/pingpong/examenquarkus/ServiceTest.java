...
public class ServiceTest {
	...
	/**
	 * Completa la definicion y el mapping de la clase NormalItem a la tabla t_items
	 */
	@Test
	...
	/**
	 * Completa la definicion y el mapping de la clase Usuaria a la tabla t_users
	 */
	@Test
	...
	/**
	 * Completa la definicion y el mapping de la clase Orden a la tabla t_ordenes El
	 * id de esta clase ha de seguir una estrategia Identity
	 */
	@Test
	...
	/**
	 * Crea una clase llamada ServiceItem e indica que es una dependencia Quarkus
	 */
	...
	/**
	 * Implementa el metodo cargaUsuaria del servicio. Devuelve la usuaria con el
	 * nombre indicado, si existe. Si no existe, devuelve un objeto usuaria con sus
	 * propiedades y valores como se indica en los casos test.
	 */
	@Test
	...
	/**
	 * Implementa el metodo cargaItem del servicio. Devuelve el item con el nombre
	 * indicado, si existe. Si no existe, devuelve un objeto usuaria con sus
	 * propiedades y valores como se indica en los casos test.
	 */
	...
	/**
	 * Implementa el metodo cargaOrden del servicio. Devuelve una lista con los
	 * pedidos de la usuaria con el nombre indicado, si existe. Si no existe,
	...
	/**
	 * Implementa el metodo "comanda" del servicio que permite a una usuaria pedir
	 * un item. La usuaria y el item ya existen en la bbdd (NO has de crearlos).
	 * 
	...
	public void test_comanda_ok() {
		...
		TypedQuery<Orden> query = em.createQuery(
				"select orden from Orden orden join orden.usuaria usuaria where usuaria.nombre = 'Hermione'",
				Orden.class);
	...
	/**
	 * Implementa el metodo comanda del servicio para que NO permita generar pedidos
	 * de productos si no existe la usuaria en la base de datos.
	 */
	@Test
	...
	/**
	 * Implementa el metodo comanda del servicio para que NO permita generar pedidos
	 * de productos si no existe el item en la base de datos.
	 */
	@Test
	...
	/**
	 * Modifica el metodo comanda para que NO permita generar pedidos de productos
	 * cuando la destreza de la usuaria sea menor que la calidad del Item.
	 */
	@Test
	...
	/**
	 * Implementa el metodo comandaMultiple para que una usuaria pueda ordenar más
	 * de un Item a la vez. Guarda las ordenes en la base de datos.
	 * 
	 * El metodo devuelve las ordenes creadas.
	 * 
	 * No se crean ordenes si la usuaria no existe previamente en la base de datos.
	 * 
